...
mpcTools = {"HUB"   :   "mel.eval('hubInterface()')",
            ...
            "Video Reference"   :   "mel.eval(\'autoMenu_launch \"/mpc/byron1/hailin-l/ion/containers/d5/6a/95bf71fe9f985ac8362bfee050ac89417a22/mpc/maya/plug-ins/_mel/animationTools//menu/camera/videoReferenceManager.mel\" \"animationAuto\"\')",
            "Anim Library"      :   "from mpc.maya.animationTools.thirdParty import studioLibrary; studioLibrary.runPoseLibrary()",
